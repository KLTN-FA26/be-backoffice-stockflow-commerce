...
public record SaveSupplierRequest(
        ...
        @Min(0) @Max(365) Integer paymentTermDays,
    ...
    public SaveSupplierRequest {
        paymentTermDays = paymentTermDays == null ? 30 : paymentTermDays;
        leadTimeDays = leadTimeDays == null ? 7 : leadTimeDays;
    }

    @jakarta.validation.constraints.AssertTrue(message = "The selected communication channel requires a valid contact")
    ...
    @jakarta.validation.constraints.AssertTrue(message = "Phone must contain between 8 and 15 digits")
