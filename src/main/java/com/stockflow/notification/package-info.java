/**
 * <b>Templated email, SMS and in-app notifications</b>
 *
 * <p>WBS 3.19.2 · database schema {@code notification}</p>
 *
 ...
 *       may import, which is why a dependency on this module is written {@code "notification :: api"}.</li>
