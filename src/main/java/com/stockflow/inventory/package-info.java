/**
 * <b>Location-level stock, ATP, reservations, counts, transfers</b>
 *
 * <p>WBS 3.6 + 3.10 · database schema {@code inventory}</p>
 *
 * <p><b>May depend on:</b> warehouse. Plus {@code common} and {@code contracts}, which are
 ...
 *       may import, which is why a dependency on this module is written {@code "inventory :: api"}.</li>
